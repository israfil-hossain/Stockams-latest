      ...
      {reviewData?.length === 0 ? (
        ...
        <>
          <View className="pt-5 flex flex-row justify-center space-x-2 items-center">
            ...
            <Text className="text-[20px]  font-[outfit-medium]">
              {averageRating}
            </Text>
          </View>
          ...
          <View className="border-2 mx-3 border-primary rounded-xl px-5 py-5">
            <View className="pb-3 flex flex-row justify-start items-center space-x-3">
              <View className="w-[50px] flex-row space-x-2 items-center">
                <Text className="text-[14px] font-[outfit-medium] w-[10px]">
                  5
                </Text>
              ...
              <View className="flex-row justify-between items-center">
                ...
                <Text className="w-[50px] font-[outfit-medium]">
                  {ratingCount[5] || 0}
                </Text>
              </View>
            </View>
              ...
              <View className="mx-2 mt-5 px-2 py-2">
                <View className="flex-row justify-between">
                  <View className="flex-row space-x-3">
                    ...
                    <View className="">
                      <Text className="font-[outfit-medium] text-[16px] capitalize">
                        {item?.reviewer?.fullName}
                      </Text>
                      <Text className="font-[outfit] text-gray-400">
                        {calculateDaysAgo(item?.createdAt) + " day ago"}
                      </Text>
                    </View>
                  </View>
                  <View className="w-[50px] flex-row space-x-2 items-center">
                    <Image source={starbroken} className="w-[20px] h-[20px]" />
                    <Text className="text-[14px]  w-[10px] font-[outfit-medium]">
                      5
                    </Text>
                  </View>
                </View>
                <Text className="pt-2 text-[16px] font-[outfit] text-gray-500">
                  {item?.comment}
                </Text>
              </View>
            )}
